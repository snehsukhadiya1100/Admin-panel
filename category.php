...
if($_POST)
{
    ...
    $query = mysqli_query($connection,"insert into tbl_category(cat_name) values('{$cname}')") or die (mysqli_error($connection));
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="txt" class="form-control" id="inputEmail1" name="cname" placeholder="Enter Product Name" required>
