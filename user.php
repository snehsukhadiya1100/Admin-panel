                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="txt" class="form-control" id="inputEmail" name="name" placeholder="Enter  Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="txt" class="form-control" id="inputPassword1" name="gender" placeholder="Enter Gender" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">Email</label>
                                <div class="col-lg-10">
                                <input type="txt" class="form-control" id="inputPassword1" name="email" placeholder="Enter email" required>
                                </div>
                            </div>      
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">Mobile</label>
                                <div class="col-lg-10">
                                <input type="number" class="form-control" id="inputPassword1" name="mobile" placeholder="Enter Mobile" required>
                                </div>
                            </div> 
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">Address</label>
                                <div class="col-lg-10">
                                <input type="address" class="form-control" id="inputPassword1" name="address" placeholder="Enter Address" required>
                                </div>
                            </div>                       
                            <div class="form-group">
