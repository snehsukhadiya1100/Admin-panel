                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="txt" class="form-control" id="inputEmail1" name="pname" placeholder="Enter Product Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="txt" class="form-control" id="inputPassword1" name="pprice" placeholder="Enter Product Price" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">Product Detail</label>
                                <div class="col-lg-10">
                                    <textarea class="form-conntrol" name="pdetails" required></textarea>
                                </div>
                            </div>                            
                            <div class="form-group">
